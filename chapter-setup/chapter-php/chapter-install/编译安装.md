...
```
$ yum install pcre pcre-devel  zlib zlib-devel glibc glibc-devel glib2 glib2-devel bzip2 bzip2-devel curl curl-devel openssl openssl-devel openldap openldap-devel nss_ldap openldap-clients openldap-servers libmcrypt libmcrypt-devel mcrypt mhash libidn libidn-devel libxml2 libxml2-devel libXpm-devel gmp gmp-devel aspell-devel recode-devel bison re2c libicu-devel systemtap-sdt-devel sqlite sqlite-devel libdb-devel gdbm gdbm-devel enchant enchant-devel
```
