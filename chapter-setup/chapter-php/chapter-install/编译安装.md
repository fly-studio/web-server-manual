...
$ yum install pcre pcre-devel gd libjpeg libjpeg-devel libpng libpng-devel freetype freetype-devel zlib zlib-devel glibc glibc-devel glib2 glib2-devel bzip2 bzip2-devel curl curl-devel openssl openssl-devel openldap openldap-devel nss_ldap openldap-clients openldap-servers libmcrypt libmcrypt-devel mcrypt mhash php-mcrypt libidn libidn-devel libxml2 libxml2-devel  libXpm-devel gmp-devel aspell-devel recode-devel bison re2c libicu-devel
```
